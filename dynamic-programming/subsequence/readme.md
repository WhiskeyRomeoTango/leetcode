...
|**2: `2`**  |  |  | **`LIS(2)=[2]`<br/>`dp[2]=1`** | **`LIS(2)+[5] <- [2,5]`<br/>`dp[3]=2`** | **`LIS(2)+[3] <- [2,3]`<br/>`dp[4]=2`** | `LIS(2)+[7] <- [2,7]`<br/>`dp[5]=2` |
|**3: `5`**  |  |  |  | `LIS(3)=[5]`<br/>`dp[3]=1` | `5 > 3`<br/>`Not LIS` | **`LIS(3)+[7] <- [2,5,7]`<br/>`dp[5]=3`** |
|**4: `3`**  |  |  |  |  | `LIS(4)=[3]`<br/>`dp[4]=1` | **`LIS(4)+[7] <- [2,3,7]`<br/>`LIS(5)=1+2=3`** |
