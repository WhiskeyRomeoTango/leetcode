...
|:----------:|:-----:|:----:|:----:|:----:|:----:|:----:|
|**0: `10`** | **`LIS(0)=[10]`<br/>`dp[0]=1`** | `10 > 9`<br/>`Not LIS` | `10 > 2`<br/>`Not LIS` | `10 > 5`<br/>`Not LIS` | `10 > 3`<br/>`Not LIS` | `10 > 7`<br/>`Not LIS` |
|**1: `9`**  |  | **`LIS(1)=[9]`<br/>`dp[1]=1`** | `9 > 2`<br/>`Not LIS` | `9 > 5`<br/>`Not LIS` | `9 > 3`<br/>`Not LIS` | `9 > 7`<br/>`Not LIS` |
|**2: `2`**  |  |  | **`LIS(2)=[2]`<br/>`dp[2]=1`** | **`LIS(3)=LIS(2)+[5]=[2,5]`<br/>`dp[3]=2`** | **`LIS(4)=LIS(2)+[3]=[2,3]`<br/>`dp[4]=2`** | `LIS(5)=LIS(2)+[7]=[2,7]`<br/>`dp[5]=2` |
|**3: `5`**  |  |  |  | `LIS(3)=[5]`<br/>`dp[3]=1` | `5 > 3`<br/>`Not LIS` | **`LIS(5)=LIS(3)+[7]=[2,5,7]`<br/>`dp[5]=3`** |
|**4: `3`**  |  |  |  |  | `LIS(4)=[3]`<br/>`dp[4]=1` | **`LIS(5)=LIS(4)+[7]=[2,3,7]`<br/>`LIS(5)=3`** |
